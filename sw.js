...
const CACHE_NAME = "haven-shell-v40";
const APP_SHELL = [
  "/app.html",
  "/manifest.json",
  "/favicon.ico",
  "/css/style.css?v=20260811b",
  "/js/app.js?v=20260811a",
  "/js/store.js?v=20260811a",
  "/js/ui.js?v=20260808g",
  "/js/crypto.js?v=20260811b",
  "/js/webauthn.js?v=20260807a",
  "/js/sync.js?v=20260810a",
