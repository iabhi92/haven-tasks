...
import { importDek, decryptTask, base64UrlToBuf } from "./crypto.js?v=20260804j";
import { pullShare } from "./sync.js?v=20260804j";
...
async function main() {
  ...
  if (!share) {
    showError("This link has expired or no longer exists. Share links last 7 days.");
    return;
  }
